...
import com.team23.presentation.recipe.models.ingredientsUiModelPreviewSamples
						...
						when (ingredientsUiModel) {
							...
							is IngredientsUiModel.FromAddScreen -> {
								AddTextField(
									...
									placeholder = stringResource(id = R.string.add_recipe_ingredient_quantity),
									singleLine = true,
								...
								AddTextField(
									...
									style = MaterialTheme.typography.bodyLarge,
									placeholder = stringResource(id = R.string.add_recipe_ingredient_unit),
									singleLine = true,
									modifier = Modifier.width(50.dp)
								)
								AddTextField(
									...
									style = MaterialTheme.typography.bodyLarge,
									placeholder = stringResource(id = R.string.add_recipe_ingredient_label),
									singleLine = true,
